...
HydroNNLayer = HydroModels.HydroNNLayer
HydroNNModel = HydroModels.HydroNNModel
...
single_layer1 = HydroNNLayer(name=:surface, fluxes=fluxes_1, dfluxes=dfluxes_1)
single_layer2 = HydroNNLayer(name=:surface, fluxes=fluxes_2, dfluxes=dfluxes_2)

# # multi node input
# node_num = 10
# mul_ele = HydroNNLayer(name=:surface, fluxes=fluxes_1, dfluxes=dfluxes_1)
...
# config = (ptyidx=1:10, styidx=1:10, timeidx=ts, interp=LinearInterpolation, solver=HydroModels.ManualSolver{true}())
