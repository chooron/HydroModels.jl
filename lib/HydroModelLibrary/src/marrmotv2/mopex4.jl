@reexport module Mopex4
using ..HydroModels
using ..HydroModelLibrary

@variables S1 S2 S3 S4 S5
@variables prcp pet temp
@variables ps pr qn et1 i q1f qw et2 q2f q2u qf qs
...
funcs_2 = [
    ...
    InterceptionFlux((in=pr), (p1=i_alpha, p2=i_s, p3=tmax), Val(4), interception=i),
...
mopex4_bucket_1 = HydroBucket(name=:mopex4_bucket_1, funcs=funcs_1, dfuncs=dfuncs_1)
mopex4_bucket_2 = HydroBucket(name=:mopex4_bucket_2, funcs=funcs_2, dfuncs=dfuncs_2)
mopex4_bucket_3 = HydroBucket(name=:mopex4_bucket_3, funcs=funcs_3, dfuncs=dfuncs_3)
mopex4_bucket_4 = HydroBucket(name=:mopex4_bucket_4, funcs=funcs_4, dfuncs=dfuncs_4)

mopex4_model = HydroModel(name=:mopex4, components=[mopex4_bucket_1, mopex4_bucket_2, mopex4_bucket_3, mopex4_bucket_4, q_flux])

export mopex4_bucket_1, mopex4_bucket_2, mopex4_bucket_3, mopex4_bucket_4, mopex4_model
end
