@reexport module Mopex2
using ..HydroModels
using ..HydroModelLibrary

@variables S1 S2 S3 S4 S5
@variables prcp pet temp
@variables ps pr qn et1 q1f qw et2 q2u qf qs
...
# Bucket 3: Root zone storage
funcs_3 = [
    EvaporationFlux((S=S3, in=pet), (Smax=se,), Val(7), evaporation=et2),
    BaseflowFlux((S=S3,), (p1=tu,), Val(1), baseflow=q2u)
]

dfuncs_3 = [
    StateFlux([qw] => [et2, q2u], S3)
]
...
mopex2_bucket_1 = HydroBucket(name=:mopex2_bucket_1, funcs=funcs_1, dfuncs=dfuncs_1)
mopex2_bucket_2 = HydroBucket(name=:mopex2_bucket_2, funcs=funcs_2, dfuncs=dfuncs_2)
mopex2_bucket_3 = HydroBucket(name=:mopex2_bucket_3, funcs=funcs_3, dfuncs=dfuncs_3)
mopex2_bucket_4 = HydroBucket(name=:mopex2_bucket_4, funcs=funcs_4, dfuncs=dfuncs_4)

mopex2_model = HydroModel(name=:mopex2, components=[mopex2_bucket_1, mopex2_bucket_2, mopex2_bucket_3, mopex2_bucket_4, q_flux])

export mopex2_bucket_1, mopex2_bucket_2, mopex2_bucket_3, mopex2_bucket_4, mopex2_model
end
